...
function FAQ() {
   ...
   const questionAnswer = [
    {
        question: 'How Do We Determine Your Needs?',
        answer: 'When you contact us, we arrange an online meeting to understand your needs and explore the options we offer. Based on your project, we deliver a sample design for your approval, ensuring we meet your vision perfectly.'
    },

    {
        question: 'How Long Does a Project Take?',
        answer:'Typically, we deliver your final site within a week after design confirmation. Our goal is to provide you with a high-quality website swiftly and efficiently'
    },
    {
        question: 'Do We Offer Website Maintenance?',
        answer: 'Yes, we offer comprehensive website maintenance, including minor text or image changes and domain upkeep. This service comes with a small additional fee, alongside your domain provider charges.'
    },
    {
        question: 'Do We Offer Free Revisions?',
        answer: 'Absolutely! We provide 3 free revisions or changes to your website within the first month of delivery. After that, a small fee applies for any changes. If you anticipate needing frequent updates, consider our maintenance package for ongoing support.'
                ...
                questionAnswer.map((faq)=>(
                    ...
                    <div class="flex flex-row items-start mb-5">
                        ...
                        <div class="bg-gray-100 p-5 px-10 w-full flex items-center">
                            <h4 class="text-md leading-6 font-medium text-gray-900">{faq.question}</h4>
                        </div>
                    </div>

                    <div class="flex flex-row items-start">
                        <div class="bg-indigo-100 p-5 px-10 w-full flex items-center">
                            <p class="text-gray-700 text-sm">{faq.answer}
                            </p>
                        </div>
                        <div
