    ...
    <section class="py-24">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <h3 class="text-3xl sm:text-4xl leading-normal font-extrabold tracking-tight text-gray-900 custom-heading">
                Amazing<span class="custom-gradient-text"> Features</span>
            </h3>
            <br/>
            ...
            <div
                ...
                <div class="relative w-full text-center max-md:max-w-sm max-md:mx-auto group md:w-2/5 lg:w-1/4">
                    ...
                    <h4 class="text-lg font-medium text-gray-900 mb-3 capitalize custom-gradient-text">
                       Up-to-Date Design 
                    </h4>
                    <p class="text-sm font-normal text-gray-500">
                    We ensure your digital presence stays current with the latest design trends and technologies.
                    </p>
                </div>
                <div class="relative w-full text-center max-md:max-w-sm max-md:mx-auto group md:w-2/5 lg:w-1/4">
                    ...
                    <p class="text-sm font-normal text-gray-500">
                    Seamlessly integrate essential services and tools to enhance your website’s functionality and user experience
                    </p>
                </div>
                <div class="relative w-full text-center max-md:max-w-sm max-md:mx-auto group md:w-2/5 lg:w-1/4">
                    ...
                    <p class="text-sm font-normal text-gray-500">
                    Efficiently manage your data and get analytics on dashboards
                    </p>
                </div>
                <div class="relative w-full text-center max-md:max-w-sm max-md:mx-auto group md:w-2/5 lg:w-1/4">
                    ...
                    <p class="text-sm font-normal text-gray-500">
                    Our designs prioritize intuitive navigation and usability
                    </p>
                </div>
            </div>
        </div>
